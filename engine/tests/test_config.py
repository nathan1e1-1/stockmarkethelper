...
def test_live_config_yaml_uses_an_approved_profile():
    ...
    import autotrader.config as config_module
    ...
    # A drift in the approved exact-values would fail at launch; catch it in CI.
    config_module._validate_paper_profile(raw)
